...
#open nc file
ds = xr.open_dataset(".././initial_GEOSChem_rst.2x25_RnPbBePasv_72L.nc")

#get list of molecules
molec = list()
pattern = "(SPC_\w+)"
for i, line in enumerate(open('../RnPbBe_species.txt')):
...
#save to netcdf file
dataset.to_netcdf('c48_132_lvl_tracer_rst.nc','w')
